...
\begin{table}[h]
    ...
    \input{Latex/Batch 1_Preparatory calculations_completed}
...
\begin{table}[h]
    ...
    \input{Latex/Batch 1_Estimated Properties}
    \label{tab:Batch1 mesured}
\end{table}
...
\begin{table}[h]
    \centering
    \caption{Alloys weighed out}
    \input{Latex/Batch 1_target vs measured atomic composition}
    \label{tab:Batch1 mesured}
\end{table}
...
\begin{table}
    ...
    \input{Latex/Batch 2_Estimated Properties}
    \label{tab:Batch1 mesured}
\end{table}
